  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed top-0 right-0 z-50 w-[300px] max-w-[85vw] h-full bg-white shadow-xl transition-transform duration-300 ease-out ${
                ...
                <Link
                  ...
                  className={`block py-3 px-3 rounded-lg text-base font-medium transition-colors ${
                    pathname === link.href || pathname.startsWith(link.href + '/')
                      ...
                      : 'text-gray-700 hover:text-turquoise-600 hover:bg-gray-50'
                  }`}
                >
                  {link.label}
                </Link>
