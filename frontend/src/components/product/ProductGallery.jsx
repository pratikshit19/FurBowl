...
export default function ProductGallery({ images, productName }) {
  ...
  if (!images || images.length === 0) {
    return (
      <div className="aspect-square bg-white rounded-sm flex items-center justify-center text-plum-900/20 border border-plum-900/10 shadow-sm">
  ...
  return (
    <div className="space-y-4">
      {/* Main image */}
      <div className="aspect-square bg-white rounded-sm overflow-hidden border border-plum-900/10 shadow-sm relative p-4 md:p-6 flex items-center justify-center">
        <Image
          src={activeImgUrl}
