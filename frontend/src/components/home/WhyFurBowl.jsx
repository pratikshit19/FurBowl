...
const PILLARS = [
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-[#15aec0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  },
  {
    ...
    icon: (
      <svg className="w-6 h-6 text-[#15aec0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
