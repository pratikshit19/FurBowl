    ...
    <section className="section-padding bg-white" aria-labelledby="contact-section-heading">
      <div className="container-main space-y-16">
        ...
        <div className="relative rounded-sm bg-plum-900 text-white p-8 sm:p-12 overflow-hidden shadow-xl">
          <div className="grid lg:grid-cols-12 gap-8 items-center relative z-10">
              ...
              {subscribed ? (
                ...
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 pt-2 max-w-md">
                  <input
                    ...
                    className="flex-1 bg-white text-plum-900 font-medium px-4 py-3.5 rounded-sm text-sm placeholder-plum-900/40 border border-plum-900/10 focus:outline-none focus:border-coral-500 focus:ring-1 focus:ring-coral-500/30 transition-all"
                  />
                  <button
                    type="submit"
                    className="bg-coral-500 hover:bg-coral-600 text-white font-extrabold px-6 py-3.5 rounded-sm text-sm transition-all shadow-md active:scale-95 shrink-0"
                  >
                    Subscribe
                  </button>
                </form>
            ...
            <div className="lg:col-span-5 flex justify-center lg:justify-end items-end relative h-[200px] sm:h-[240px]">
              <div className="relative w-48 sm:w-56 h-48 sm:h-56 rounded-sm bg-[#cff0f3] overflow-hidden border-2 border-white/30 shadow-xl">
                <Image
                  src="/images/dog2.jpg"
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-sm border border-plum-900/10 shadow-sm text-center">
