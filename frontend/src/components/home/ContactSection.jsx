...
export default function ContactSection() {
  ...
  return (
    <section className="section-padding bg-white" aria-labelledby="contact-section-heading">
      <div className="container-main space-y-16">
        
        {/* Newsletter Banner — Dark Plum/Charcoal with Dog Photo */}
        <ScrollReveal delay={0}>
          <div className="relative rounded-sm bg-plum-900 text-white p-8 sm:p-12 overflow-hidden shadow-xl">
            <div className="grid lg:grid-cols-12 gap-8 items-center relative z-10">
              
              {/* Left — Email Form */}
              <div className="lg:col-span-7 space-y-4">
                <div className="flex items-center gap-2.5">
                  <div className="w-9 h-9 rounded-sm bg-coral-500 flex items-center justify-center text-white shrink-0">
                ...
                {subscribed ? (
                  <div className="bg-white/10 border border-white/20 p-4 rounded-sm text-butter-300 font-bold text-sm flex items-center gap-2">
                  ...
                  <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 pt-2 max-w-md">
                    <input
                      ...
                      className="px-4 py-3 rounded-sm bg-white/10 border border-white/20 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-coral-500 focus:bg-white/15 flex-1"
                      required
                    />
                    <button
                      type="submit"
                      className="px-6 py-3 bg-coral-500 hover:bg-coral-600 text-white font-bold text-sm rounded-sm transition-colors shadow-sm shrink-0"
                    >
                      Subscribe
                    </button>
                  </form>
              ...
              {/* Right — Dog Photo with Subtle Glow */}
              <div className="lg:col-span-5 flex justify-center lg:justify-end">
                <div className="relative w-64 h-64 sm:w-72 sm:h-72">
                  <div className="absolute inset-0 rounded-full bg-coral-500/10 blur-xl scale-95" />
                  <Image
                    src="/images/home/about-dog-parent.png"
                    alt="Happy dog parent hugging dog"
                    fill
                    className="object-cover rounded-2xl shadow-lg border border-white/10"
                    sizes="(max-width: 640px) 256px, 288px"
                  />
                  <div className="absolute bottom-3 left-3 bg-plum-900/90 backdrop-blur-xs border border-white/20 rounded-sm px-3 py-1.5 shadow-md">
                    <span className="text-[11px] font-bold text-butter-300">10,000+ Happy Dogs</span>
                  </div>
                </div>
              </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          <ScrollReveal delay={0} className="h-full">
            <div className="bg-white p-6 rounded-sm border border-plum-900/10 shadow-sm text-center h-full flex flex-col justify-between">
              <div>
                <div className="w-12 h-12 rounded-sm bg-[#cff0f3] text-[#15aec0] flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-[#15aec0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                  </svg>
                </div>
          ...
          <ScrollReveal delay={80} className="h-full">
            <div className="bg-white p-6 rounded-sm border border-plum-900/10 shadow-sm text-center h-full flex flex-col justify-between">
              <div>
                <div className="w-12 h-12 rounded-sm bg-[#cff0f3] text-emerald-600 flex items-center justify-center mx-auto mb-3">
