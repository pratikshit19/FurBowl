  ...
  return (
    <section id="quiz-section" className="py-14 sm:py-20 bg-white border-b border-plum-900/5 relative overflow-hidden">
      <div className="container-main max-w-6xl">
        ...
        {step < 3 && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-butter-50/50 rounded-3xl border border-plum-900/10 p-6 sm:p-10 shadow-sm">
        ...
        {step === 3 && (
          <div className="bg-gradient-to-b from-butter-50 to-white rounded-3xl border border-plum-900/10 p-6 sm:p-10 shadow-sm">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-5">
                {matches.topMatch && (
                  <div className="bg-white rounded-2xl border-2 border-coral-500/30 p-5 shadow-lg relative overflow-hidden group hover:border-coral-500 transition-all">
                    ...
                    <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden mb-4 bg-butter-50 flex items-center justify-center p-2">
                      <Image
                    ...
                    <Link
                      ...
                      className="w-full bg-plum-900 hover:bg-plum-800 text-white font-bold text-xs py-3 rounded-full text-center block transition-all shadow-sm"
                    >
                      View Product →
                    </Link>
                  </div>
