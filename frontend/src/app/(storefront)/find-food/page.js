          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="px-6 py-3 border border-plum-900/20 text-plum-900 rounded-md font-medium text-sm hover:border-plum-900/40 hover:bg-plum-900/5 transition-colors"
              >
                Retake Quiz
              </button>
              <Link
                href={`/shop/${recommendedProduct.slug}`}
                className="px-6 py-3 bg-turquoise-600 text-white rounded-md font-semibold text-sm hover:bg-turquoise-700 transition-colors"
              >
