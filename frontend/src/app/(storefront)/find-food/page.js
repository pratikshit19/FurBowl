  ...
  const getResults = () => {
    if (selectedProtein === 'chicken') {
      return {
        ...
        topMatch: MOCKUP_RECIPES.find((r) => r.id === 'chicken-vegetables'),
        secondMatch: MOCKUP_RECIPES.find((r) => r.id === 'chicken-rice-vegetables'),
        wildCard: MOCKUP_RECIPES.find((r) => r.id === 'egg-superfood'),
      };
    }
    if (selectedProtein === 'lamb') {
      return {
        ...
        topMatch: MOCKUP_RECIPES.find((r) => r.id === 'lamb-lentils'),
        secondMatch: MOCKUP_RECIPES.find((r) => r.id === 'chicken-vegetables'),
        wildCard: MOCKUP_RECIPES.find((r) => r.id === 'egg-superfood'),
      };
    }
    if (selectedProtein === 'egg') {
      return {
        ...
        topMatch: MOCKUP_RECIPES.find((r) => r.id === 'egg-superfood'),
        secondMatch: MOCKUP_RECIPES.find((r) => r.id === 'paneer-vegetables'),
        wildCard: MOCKUP_RECIPES.find((r) => r.id === 'chicken-vegetables'),
      };
    }
    return {
      ...
      topMatch: MOCKUP_RECIPES.find((r) => r.id === 'paneer-vegetables'),
      secondMatch: MOCKUP_RECIPES.find((r) => r.id === 'egg-superfood'),
      wildCard: MOCKUP_RECIPES.find((r) => r.id === 'chicken-vegetables'),
    };
  };
      ...
      <div className="container-main max-w-5xl">
        ...
        {step < 3 && (
          <ScrollReveal delay={0}>
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white rounded-xl border-2 border-plum-900/10 p-6 sm:p-12 shadow-sm">
                  ...
                  <div>
                    <div className="mb-6">
                      ...
                      <input
                        ...
                        className="w-full max-w-xs px-4 py-2.5 rounded-md border border-plum-900/20 text-plum-900 font-bold text-sm focus:outline-none focus:ring-2 focus:ring-coral-500/20"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
                      {PROTEIN_OPTIONS.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <div className={`w-11 h-11 rounded-md flex items-center justify-center mb-2 transition-colors ${
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        type="button"
                        onClick={() => setStep(1)}
                        className="bg-white border border-plum-900/20 hover:bg-butter-100 text-plum-900 font-bold text-sm px-5 py-3.5 rounded transition-all inline-flex items-center gap-1.5"
                      >
        ...
        {step === 3 && (
          <ScrollReveal delay={0}>
            <div className="bg-white rounded-xl border-2 border-plum-900/10 p-6 sm:p-12 shadow-sm">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-5">
                  {results.topMatch && (
                    <div className="bg-butter-50/60 rounded-lg border-2 border-coral-500/40 p-5 shadow-lg relative overflow-hidden group hover:border-coral-500 transition-all">
